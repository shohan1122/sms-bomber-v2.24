...
def check():
    ...
    if not ("Author : ToxicNoob" in file) or not ("GitHub : https://github.com/Termux hacker" in file) or not ("ToxicBomber" in file) or not ("https://raw.githubusercontent.com/Toxic-Noob/ToxicBomber/main/more/.version" in file):
