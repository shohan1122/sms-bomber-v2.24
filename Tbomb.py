...
def update():
    ...
    os.system("cd .. && rm -rf Bdbomber && git clone https://github.com/Toxic-Noob/ToxicBomber > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd Bdbomber && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Termux hacker                  \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/termux_hacker \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : hackerSl4d3              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
